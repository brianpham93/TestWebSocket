...
namespace GSEP_DLL.Models
{
    ...
    #region TimelineAndNewsfeedModel
    public class TimelineAndNewsfeedModel
    {
        ...
        public TimelineAndNewsfeedModel(PostResultModel post, ShareQuestionResultModel sharedQuestion, Achievement achievement, Double time)
        {
            this.Post = post;
